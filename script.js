...
const i18n = {
  en: {
    ...
    'hero.eyebrow': 'Engineering solutions that drive progress',
    'hero.title': 'Engineering ideas into <span>real products</span>.',
    'hero.copy': 'JAKS combines 3D design, electronics, mechanics, and automation to engineer launch-ready products with premium branding.',
    'hero.primary': 'Explore projects',
    'hero.secondary': 'How we work',
    'hero.tag1': '3D Product Development',
    'hero.tag2': 'Smart NFC + IoT Systems',
    'hero.tag3': 'Mechanical Innovation + Automation',
    ...
    'projects.title': 'Real projects. <span>Real impact.</span>',
    ...
    'projects.p5': 'Connected touchpoint products designed to create premium first impressions and frictionless access.',
    'projects.p6': 'Custom illuminated branding pieces for desks, studios, events, and client-facing spaces.',
  ...
  es: {
    ...
    'hero.eyebrow': 'Soluciones de ingeniería que impulsan progreso',
    'hero.title': 'Transformamos ideas de ingeniería en <span>productos reales</span>.',
    'hero.copy': 'JAKS integra diseño 3D, electrónica, mecánica y automatización para crear productos listos para lanzamiento con imagen premium.',
    'hero.primary': 'Explorar proyectos',
    'hero.secondary': 'Cómo trabajamos',
    'hero.tag1': 'Desarrollo de producto 3D',
    'hero.tag2': 'Sistemas NFC + IoT',
    'hero.tag3': 'Innovación mecánica + automatización',
    ...
    'projects.title': 'Proyectos reales. <span>Impacto real.</span>',
    ...
    'projects.p5': 'Productos conectados diseñados para una primera impresión premium y acceso inmediato.',
    'projects.p6': 'Piezas iluminadas personalizadas para escritorios, estudios, eventos y espacios comerciales.',
